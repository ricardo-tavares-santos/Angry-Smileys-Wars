...
public class Pick_MinigunControler : MonoBehaviour {
    ...
    {
        if (_GameControler._GameObj.tag == "Player") _GameControler._ListStatePickPlayer[12].Ammo -= 1; else _GameControler._ListStatePickEnemy[12].Ammo -= 1;
