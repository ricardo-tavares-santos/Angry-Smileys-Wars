...
public class Pick_Grenade_PoisonControler : MonoBehaviour {
  ...
  //  public GameObject _Explosion;
    ...
    {
        if (_GameControler._GameObj.tag == "Player") _GameControler._ListStatePickPlayer[13].Ammo -= 1; else _GameControler._ListStatePickEnemy[13].Ammo -= 1;
